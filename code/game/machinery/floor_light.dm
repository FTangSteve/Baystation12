...
/obj/machinery/floor_light
	...
	var/default_light_max_bright = 2
...
/obj/machinery/floor_light/proc/update_brightness()
	if(on && use_power == 2)
		if(light_outer_range != default_light_outer_range || light_max_bright != default_light_max_bright || light_color != default_light_colour)
			set_light(default_light_outer_range, default_light_max_bright, default_light_colour)
	else
		use_power = 0
		if(light_outer_range || light_max_bright)
			set_light(0)

	active_power_usage = ((light_outer_range + light_max_bright) * 10)
	update_icon()
